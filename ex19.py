...
cheese_and_crackers(amount_of_cheese,amount_of_crackers) #when you use the function, the number of the arguments should match but not necesserily the names
